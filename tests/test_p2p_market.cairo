...
func test_proxy_contract{syscall_ptr: felt*, range_check_ptr}() {
    ...
    %{ 
        ids.erc1155_address = deploy_contract("./src/p2p_resources_market/asset_erc1155.cairo").contract_address 
        ids.contract_address = deploy_contract("./src/p2p_resources_market/p2p_market.cairo", [ids.caller, ids.erc1155_address]).contract_address 
    %}
    ...
    //_get_assets_ids_storage
    //_get_amounts_ids_storage
    // check new counter
